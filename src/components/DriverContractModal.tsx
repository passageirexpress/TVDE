...
export default function DriverContractModal({ driver, company, onClose }: DriverContractModalProps) {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Contrato de Prestação de Serviços TVDE - ${driver.full_name}</title>
          <style>
            body {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50">
          <h2 className="text-xl font-bold text-gray-800">Contrato de Prestação de Serviços TVDE</h2>
          ...
          <div ref={printRef} className="max-w-3xl mx-auto">
            ...
            <div className="signature-block">
              ...
              <div style={{ marginTop: '40px', display: 'flex', justifyContent: 'space-between' }}>
                ...
                <div>
                  <p className="bold">O PRESTADOR</p>
                  <div className="signature-line"></div>
                  <p>Assinatura</p>
                </div>
              </div>
